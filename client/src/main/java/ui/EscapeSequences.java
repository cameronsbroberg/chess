...
public class EscapeSequences {
    ...
    public static final String SET_BG_COLOR_DARK_YELLOW = SET_BG_COLOR + "142m";
    public static final String SET_BG_COLOR_MEDIUM_BLUE = SET_BG_COLOR + "67m";
    public static final String SET_BG_COLOR_DARK_BLUE = SET_BG_COLOR + "32m";
